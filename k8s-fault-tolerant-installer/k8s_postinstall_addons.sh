...
# Use the kubeconfig file specified in the command line
KUBECONFIG=$1
...
# Install Rook
# Pre-requirements
echo "[K8S_POSTINSTALL] Installing Rook..."
...
echo "[K8S_POSTINSTALL] Rook installed"
...
echo "[K8S_POSTINSTALL] OpenEBS installed"

# Install Longhorn
echo "[K8S_POSTINSTALL] Installing Longhorn..."
...
echo "[K8S_POSTINSTALL] Longhorn installed"
